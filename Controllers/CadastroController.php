...
class CadastroController {
    ...
    public function cadastrarAluno($data) {
        try {
            ...
            // plano padrão (id 1) – Aluno Básico
            $idPlanoBasico = $this->buscarPlanoId('Aluno Básico', 'aluno') ?? 1;
    ...
    public function cadastrarPersonal($data) {
        try {
            ...
            $idPlanoBasico = $this->buscarPlanoId('Personal Básico', 'personal') ?? 3;
    ...
    public function cadastrarAcademia($data) {
        try {
            ...
            $idPlanoAcademia = $this->buscarPlanoId('Academia Premium', 'academia') ?? 5;
