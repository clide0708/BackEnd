<?php
    ...
    class PerfilRepository {
        ...
        public function updateAcademiaPerfil($idAcademia, $data) {
            ...
            if (isset($data["nome"])) { $updates[] = "nome = :nome"; $params[":nome"] = $data["nome"]; }
            if (isset($data["telefone"])) { $updates[] = "telefone = :telefone"; $params[":telefone"] = $data["telefone"]; }
            if (isset($data["endereco"])) { $updates[] = "endereco = :endereco"; $params[":endereco"] = $data["endereco"]; }
        ...
        public function updateDevPerfil($idDev, $data) {
            ...
            if (isset($data["nome"])) { $updates[] = "nome = :nome"; $params[":nome"] = $data["nome"]; }
            if (isset($data["nivel_acesso"])) { $updates[] = "nivel_acesso = :nivel_acesso"; $params[":nivel_acesso"] = $data["nivel_acesso"]; }
